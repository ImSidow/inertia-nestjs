...
export type AlwaysProp<T = unknown> = { _type: 'always'; fn: () => T | Promise<T> };
export type DeferProp<T = unknown> = { _type: 'defer'; fn: () => T | Promise<T>; group?: string };
export type MergeProp<T = unknown> = { _type: 'merge'; fn: () => T | Promise<T> };
